            ...
            >
              <SwiperSlide>
                <div>
                  <div className="client-logo">
                    <Link to="/">
                      <img src="assets/img/client/1-1.png" alt="Checkit Research" />
                    </Link>
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div>
                  <div className="client-logo">
                    <Link to="/">
                      <img src="assets/img/client/1-2.png" alt="Checkit Research" />
                    </Link>
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div>
                  <div className="client-logo">
                    <Link to="/">
                      <img src="assets/img/client/1-3.png" alt="Checkit Research" />
                    </Link>
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div>
                  <div className="client-logo">
                    <Link to="/">
                      <img src="assets/img/client/1-4.png" alt="Checkit Research" />
                    </Link>
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div>
                  <div className="client-logo">
                    <Link to="/">
                      <img src="assets/img/client/1-5.png" alt="Checkit Research" />
                    </Link>
                  </div>
                </div>
              </SwiperSlide>
            ...
            <div className="col-lg-7">
              <div className="testiomonial-wrap-2 bg-title">
                ...
                <div className="quote-icon">
                  <img src="assets/img/icon/quote2-1.svg" alt="Checkit Research" />
                </div>
                      ...
                      <div>
                        <div className="testi-card style2">
                          <div className="testi-card_content">
                            <div className="testi-feedback-image">
                                <img
                                src="/assets/New folder/feed.jpg"
                                alt="Client Feedback"
                                />
                              </div>
                          </div>
                      ...
                      <div>
                        <div className="testi-card style2">
                          <div className="testi-card_content">
                            <div className="testi-feedback-image">
                                <img
                                src="/assets/New folder/feed1.jpg"
                                alt="Client Feedback"
                                />
                              </div>
                          </div>
                      ...
                      <div>
                        <div className="testi-card style2">
                          <div className="testi-card_content">
                            <div className="testi-feedback-image">
                                <img
                                src="/assets/New folder/feed3.jpg"
                                alt="Client Feedback"
                                />
                              </div>
                          </div>
                      ...
                      <div>
                        <div className="testi-card style2">
                          <div className="testi-card_content">
                            <div className="testi-feedback-image">
                                <img
                                src="/assets/New folder/feed4.jpg"
                                alt="Client Feedback"
                                />
                              </div>
                          </div>
